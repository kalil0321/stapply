                                            ...
                                            <div className="flex-1 flex items-center gap-6 min-w-0">
                                                ...
                                                <div className="flex items-center gap-2 min-w-0 flex-shrink-0">
                                                    ...
                                                    <h3 className="text-md font-medium text-foreground group-hover:text-primary transition-colors truncate">
                                                        {search.query.length > 60 ? `${search.query.substring(0, 60)}...` : search.query}
                                                    </h3>
                                                    {isLiveSearch && (
                                                    ...
                                                    <div className="flex items-center gap-3 flex-wrap min-w-0">
                                                        ...
                                                        {search.status && (
                                                            <Badge
                                                                ...
                                                                className={`text-xs flex-shrink-0 ${(search.status as LiveSearchStatus) === 'completed' ? 'bg-green-500' : ''
                                                                    }`}
                                                            >
